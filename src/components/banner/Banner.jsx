...
function Banner({ card, categoryLookup }) {
  ...
  return (
    <main
      ...
      style={{ backgroundImage: `url(${banner})`, "--primary-color": primaryColor }}
    >
      ...
      <section className={styles.content}>
        ...
        <p className={styles.subtitle}>
          Este challenge es una forma de aprendizaje. Es un mecanismo donde podrás comprometerte en la
